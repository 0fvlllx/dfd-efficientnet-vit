...
def random_sample_and_copy_rename(src, des, dir_name):
...
if __name__ == '__main__':
    paths = os.walk("/data/FaceDatabase/DFDC/train_part")
    des_path = "/data/FaceDatabase/DFDC/train_part/metadata"
    for root_path, dir_list, _ in paths:
        for dir_name in dir_list:
            random_sample_and_copy_rename(os.path.join(root_path, dir_name),
                                          des_path, dir_name)
